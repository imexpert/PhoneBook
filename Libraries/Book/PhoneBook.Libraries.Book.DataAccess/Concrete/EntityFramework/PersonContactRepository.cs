...
{
    public class PersonContactRepository : EntityRepositoryBase<PersonContact, ProjectDbContext>, IPersonContactRepository
    {
        public PersonContactRepository(ProjectDbContext context)
            : base(context)
        {
        }
    }
