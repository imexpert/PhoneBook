...
using PhoneBook.Core.CrossCuttingConcerns.Logging;
using PhoneBook.Core.CrossCuttingConcerns.Logging.Serilog;
...
namespace PhoneBook.Core.Aspects.Autofac.Exception
{
    /// <summary>
    /// ExceptionLogAspect
    /// </summary>
